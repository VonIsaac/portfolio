...
const AboutMe = () => {
    return (
        <div className=' flex justify-evenly items-end my-[13rem]'>
            <img src={aboutmeSvg} alt="icon" className=' w-[400px]' data-aos="fade-right"/>
            <div className=' border bg-neutral-200 w-[40%]  p-3 rounded-xl border-none shadow-[0_3px_10px_rgb(0,0,0,0.2)]' id='colorss' data-aos="fade-left" data-aos-offset="300"
     data-aos-easing="ease-in-sine">
                <h1 className=' uppercase my-2 font-bold font-mono text-4xl ml-1 text-slate-200'>About Me</h1>

                <p className=' font-semibold font-mono text-lg text-slate-200 my-2 ml-1 '>
                ...
                <p className=' font-semibold font-mono text-lg text-slate-200 my-3 ml-1'>
