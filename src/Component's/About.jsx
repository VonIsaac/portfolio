...
const AboutMe = () => {
    return (
        <div className=' flex justify-evenly items-end mb-[10rem]' id='aboutMe-possition'>
            ...
            <div  className=' border bg-neutral-200 w-[40%]  p-3 rounded-xl border-none shadow-[0_3px_10px_rgb(0,0,0,0.2)]' id='colorss' data-aos="fade-left" data-aos-offset="420"
                data-aos-easing="ease-in-sine">
                <h1 className=' uppercase my-2 font-bold font-mono text-4xl ml-1 text-slate-200 leading-snug' id='aboutMe'>About Me</h1>

                <p className=' font-semibold font-mono text-lg text-slate-200 my-2 ml-1 leading-snug' id='aboutMe-paragraph'>
                ...
                <p className=' font-semibold font-mono text-lg text-slate-200 my-3 ml-1 leading-snug' id='aboutMe-paragraph'>
