    ...
    return(
        <>       
            <div>
                ...
                <div className='  border w-[55rem] h-[25rem] p-1 ml-[7rem] mb-[7rem] bg-gray-800 border-none rounded-2xl px-4 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]' data-aos = 'fade-right' data-aos-offset="500" data-aos-duration="500">
